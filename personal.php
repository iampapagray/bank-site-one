...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <?php
            ...
            }elseif ($product == "Susu Savings") {
                echo '<div class="breadcrumb-area bg-overlay-dark bg-16">';
            }else{
                echo '<div class="breadcrumb-area bg-overlay-dark bg-17">';
            }
        ?> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 fix">
                        <div class="single-sidebar-widget fix">
                            ...
                            <ul class="categories">
                                <li><a href="personal-banking/savings-account/">Savings Account</a></li>
                                <li><a href="personal-banking/current-account/">Current Account</a></li>
                                <li><a href="personal-banking/fixed-deposit-account/">Fixed Deposit Account</a></li>
                                <li><a href="personal-banking/susu-savings-loans/">Susu Savings and Loans</a></li>
